...
class Products
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=suppliers::class, inversedBy="ProductsRelation")
     */
    private $SupplierID;

    /**
     * @ORM\ManyToOne(targetEntity=OrderDetails::class, inversedBy="ProductID")
     */
    private $OrderDetProdRelation;
    ...
    public function getOrderDetProdRelation(): ?OrderDetails
    {
        return $this->OrderDetProdRelation;
    }

    public function setOrderDetProdRelation(?OrderDetails $OrderDetProdRelation): self
    {
        $this->OrderDetProdRelation = $OrderDetProdRelation;
