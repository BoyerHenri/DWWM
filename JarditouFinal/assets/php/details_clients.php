        ...
        <form>
            <div>
                ...
                <div class="form-check form-check-inline mr-10">
                    Disponibilité : 
                    <!-- <input class="form-check-input" type="radio" name="BLOCKED" id="OUI" value="OUI"value="OUI" disabled> -->
                    <?php if($produit->pro_bloque!=1) { echo "Produit disponible."; }?> 
                    <!-- <label class="form-check-label" for="OUI">Oui</label> -->
                <!--</div>
                <div class="form-check form-check-inline"> -->
                    <!-- <input class="form-check-input" type="radio" name="BLOCKED" id="NON" value="NON" value="NON" disabled> -->
                    <?php if($produit->pro_bloque==1) { echo "Produit indisponible."; }?>
