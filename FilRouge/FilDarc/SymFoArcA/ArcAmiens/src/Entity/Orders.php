...
class Orders
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=OrderDetails::class, inversedBy="OrderID")
     * @ORM\JoinColumn(nullable=false)
     */
    private $relationorders;

    /**
     * @ORM\ManyToOne(targetEntity=Customers::class, inversedBy="relationcustomers")
     */
    private $CustomerID;
    ...
    public function getRelationorders(): ?OrderDetails
    {
        return $this->relationorders;
    }

    public function setRelationorders(?OrderDetails $relationorders): self
    {
